...
1.  "Paint" the room. Slowly walking through your space, let the front of the headset "see" where you are, what's on the ground, what's on the walls.
...
Press the L/R button on top of the tracker. If your wrist trackers were paired last time you used the set, they will remain paired.
...
Turn on the equipment you will be using.

## OPXR App 

In the app settings you will be able to

# FAQ

support.operatorxr login
...
Settings on the laptop arent populating while headset is connected
